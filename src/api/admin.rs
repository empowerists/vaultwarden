...
async fn has_http_access() -> bool {
    let req = match make_http_request(Method::HEAD, "https://github.com/empowerists/vaultwarden") {
        Ok(r) => r,
        Err(_) => return false,
    };
        ...
        (
            ...
            if running_within_container {
                ...
                match get_json_api::<GitRelease>(
                    "https://api.github.com/repos/empowerists/bw_web_builds/releases/latest",
                )
                .await
                {
